...
urlpatterns = [
                  ...
                  url(r'^project/(?P<slug>[^/]+)/tsr/(?P<assslug>[^/]+)/$', project_views.tsr_update,
                      name='tsr_update'),
                  ...
                  # Add member to project
                  url(r'^project/(?P<slug>[^/]+)/reject/(?P<uname>[^/]+)$', project_views.reject_member,
                      name='reject_member'),
                  ...
                  url(r'^project/(?P<slug>[^/]+)/edit/ajax/edit_select_members/$', project_views.edit_select_members,
                      name='edit_select_members'),
                  url(r'^project/(?P<slug>[^/]+)/edit/ajax/add_desired_skills/$', project_views.add_desired_skills,
                      name='add_desired_skills'),
                  url(r'^project/create/ajax/add_desired_skills/$', project_views.create_desired_skills,
                      name='create_desired_skills'),
                  url(r'^project/(?P<slug>[^/]+)/edit/ajax/add_desired_technologies/$',
                      project_views.add_desired_technologies, name='add_desired_technologies'),
                  url(r'^project/create/ajax/add_desired_technologies/$', project_views.create_desired_technologies,
                      name='create_desired_technologies'),

                  # COURSE
                  # Delete individual assignment (based on slug)
                  url(r'^assignment/(?P<slug>[^/]+)/delete/$', course_views.delete_assignment,
                  ...
                  url(r'^course/(?P<slug>[^/]+)/update/(?P<id>[^/]+)/$', course_views.update_course_update,
                      name='update_course_update'),
                  # Edit existing update to course (based on slug and update id)
                  url(r'^course/(?P<slug>[^/]+)/update/(?P<id>[^/]+)/delete$', course_views.delete_course_update,
                      name='delete_course_update'),
                  ...
                  # select2 for course
                  url(r'^course/(?P<slug>[^/]+)/edit/ajax/edit_select_members/$', project_views.edit_select_members,
                      name='edit_select_members'),
                  # select2 for course
                  ...
                  # Export Interest
                  url(r'^course/(?P<slug>[^/]+)/export_interest/$', course_views.export_interest,
                      name='export_interest'),
                  # Claim Projects (TA)
                  ...
                  url(r'^user/(?P<username>[^/]+)/edit_schedule/ajax/save_event/$', profile_views.save_event,
                      name='save_event'),
                  url(r'^user/(?P<username>[^/]+)/edit/ajax/edit_skills/$', profile_views.edit_skills,
                      name='edit_skills'),
