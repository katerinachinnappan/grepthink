# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2018-02-22 19:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='projects.Project')),
            ],
        ),
        migrations.CreateModel(
            name='Column',
            fields=[
                ...
                ('tittle', models.CharField(default='', max_length=100)),
                ('description', models.CharField(default='', max_length=200)),
                ('board', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, related_name='board', to='scrumboard.Board')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
